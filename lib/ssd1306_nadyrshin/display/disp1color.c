...
//==============================================================================
// Процедура выводит на дисплей форматированную строку с выравниванием по центру
//==============================================================================
...
//==============================================================================
// Процедура рисует стрелку длиной 10 пикселей и высотой 10 пикселей
//==============================================================================
void disp1color_DrawArrow(uint16_t xCenter, uint16_t yCenter)
{
    disp1color_DrawLine(xCenter - 5, yCenter, xCenter + 5, yCenter);
    disp1color_DrawLine(xCenter - 5, yCenter + 1, xCenter + 5, yCenter + 1);
    disp1color_DrawLine(xCenter + 1, yCenter - 4, xCenter + 5, yCenter);
    disp1color_DrawLine(xCenter + 1, yCenter - 3, xCenter + 5, yCenter + 1);
    disp1color_DrawLine(xCenter + 1, yCenter + 4, xCenter + 5, yCenter);
    disp1color_DrawLine(xCenter + 1, yCenter + 5, xCenter + 5, yCenter + 1);
}
...
//==============================================================================
// Процедура переводит дисплей в спящий режим
//==============================================================================
